...
> This is a project to showcase rockets and missions. Providing a whole bunch of utilities like reserving a rocket or subscribing to a mission.
...
- Reserving a rocket
- Participating to a mission
- Showing a list of reservations
...
```
 git clone https://github.com/wassimchakib/space-travelers.git
```
